...
arguments_class = arguments(argparse.ArgumentParser(description='--- URLi is a tool that list subdomains in a application | visit https://github.com/mafadra/URLi to know more | version: v1.0.0 ---'))
